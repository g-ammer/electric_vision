function [Vtrace meanRinput var_vm pspect datamv_hist]=DataAnalysis_baselineVm_2020_03_31 (data)
...
var_vm=var(datamv(borderscurr(10)+100001:borderscurr(10)+2900000));
...
baseline=mean(datamv(borderscurr(10)+100001:borderscurr(10)+2900000));
signal=datamv(borderscurr(10)+100001:borderscurr(10)+2900000)-baseline;
...
datamv_hist=datamv(borderscurr(10)+100001:borderscurr(10)+2800000);
range=-60:0.25:60;
figure('position',[1 1 384 384]);
